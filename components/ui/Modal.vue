	...
	<transition name="modal">
		...
		>
			<div class="bg-black p-8 shadow-md absolute relative" @click.stop>
				...
				<div class="my-4 text-lg text-stone-400">
				...
				<div class="flex flex-col space-y-4">
					<div class="w-full">
						...
						<input
							id="name"
							class="block p-2 my-1 bg-stone-950 text-stone-400 shadow w-full"
					...
					<div class="w-full">
						<label for="message" class="text-stone-500"
							>Message:</label
						>
						<textarea
							id="message"
				...
				<button
					@click="$emit('close')"
					class="mt-6 px-4 py-2 bg-white text-black w-full shadow"
				>
					Let's Talk
				</button>
			</div>
