...
<template>
  <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 blog py-40">
    <!-- Header Image -->
    <img class="w-full h-64 object-cover" src="/Unite-dhabitation-Marseille_C.-Emden.jpg"
    ...
    <!-- Blog post title -->
    <h1 class="mt-4 mb-8 text-3xl font-bold">"A Website is a Machine for Information and Delight": Brutalism and UI/UX Design
    </h1>
    ...
    <div class="leading-loose text-lg">
      <p>In the post-WW2 reconstruction era, <a href="https://en.wikipedia.org/wiki/B%C3%A9ton_brut" target="_blank"
        ...
        <a href="https://www.open.edu/openlearn/history-the-arts/history/heritage/le-corbusier" target="_blank"
          class="border-b-2 border-opacity-50 hover:border-opacity-100 border-primary">machines for living in</a>.</p>
      ...
      <p>The radical shift towards functionality in architecture embodied in the Modernist movement was pushed to an
        ...
        movement championed the use of raw concrete and the creation of imposing structures, forgoing decorative embellishments.
        ...
        rebuilding again from a blank slate — of concrete or Béton Brut, of course.</p>
      ...
      <p>Le Corbusier's vision was brought to life with his seminal work <a
          ...
          class="border-b-2 border-opacity-50 hover:border-opacity-100 border-primary">Unite d'Habitation</a>,
        ...
        architecture and the push for an architecture that could address some of the
        ...
        promote their vision for a world emerging from the ashes
        of unprecedented devastation, displacement, and upheaval. In this chaotic period, societal focus shifted toward
        meeting people's basic needs through mass housing, public infrastructure, and affordability. Amidst these
        conditions,
        Brutalism stood out. Even with its fervent emphasis on function, however, Brutalism didn’t entirely sideline
      ...
      <p>
        Elements of Brutalist design can be discerned in the works and writings of several Modernist thinkers.
        In his 1908 essay "<a href="https://designmanifestos.org/adolf-loos-ornament-and-crime/" target="_blank" class="border-b-2 border-opacity-50 hover:border-opacity-100 border-primary">Ornament and Crime</a>," Alfred Loos famously wrote, "The urge to ornament one's face and
      ...
      <p>Nowadays, we are witnessing a resurgence of Brutalism in the form of neo-Brutalism. However, this new iteration
        ...
        been criticized by Alfred Loos. If the aim of Brutalism is to strip down a structure toits essence and highlight
      ...
      <p>However, the reality is that not everyone desires to delve into the nuts and bolts or engage with raw materials.
        Often, simplicity and functionality suffice. This is why, in my opinion,
        Modernism continues to hold an enduring appeal. While Brutalism acts as a necessary counterbalance that keeps
        Modernism anchored in the present, it tends to be most impactful
        when used sparingly or on the periphery.</p>

      <p>In a vein similar to Brutalist principles, contemporary web design must grapple with the interplay between
        ...
        we can refer to Dieter Rams' "<a href="https://www.vitsoe.com/us/about/good-design" target="_blank" class="border-b-2 border-opacity-50 hover:border-opacity-100 border-primary">Ten Principles for Good Design</a>" as a guide:
      </p>
